...
\end{lstlisting}
\indent
Potom ćemo kopirati status.diff datoteku u nodejsBazniDelta/var/lib/dpkg direktorij. Također obrisati status datoteku iz ovog pomenutog nodejsBazniDelta direktorija.\\
\begin{lstlisting}[style=BashInputStyle]
